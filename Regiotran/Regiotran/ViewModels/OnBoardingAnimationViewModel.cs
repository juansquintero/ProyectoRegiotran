        ...
        public OnBoardingAnimationViewModel()
        {
            ...
            this.Boardings = new ObservableCollection<Boarding>
            {
                new Boarding()
                {
                    ...
                    Header = "PASAJES",
                    Content = "Realice la compra de pasajes de manera sencilla.",
                ...
                new Boarding()
                {
                    ...
                    Header = "PAGOS",
                    Content = "Page de la manera mas sencilla con solo un boton",
                    RotatorView = new WalkthroughItemPage(),
                },
                new Boarding()
                {
                    ...
                    Header = "HISTORIAL",
                    Content = "Revise todas las compras y pagos realizados",
                    RotatorView = new WalkthroughItemPage(),
                },
            };
